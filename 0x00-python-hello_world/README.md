...
For the shell scripts and Python, the way to execute them is by putting a period and a slash before the command name. As follows:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkxOTU4MzMwOF19
-->